...
public class EnvelopedVirusStatistics {
    private final EnvelopedPage EVPage;
    private final Stage stage;
    private final HostServices hostServices;
    private final EnvelopedVirusMenu EVmenu;

    public EnvelopedVirusStatistics(EnvelopedPage EVPage, HostServices hostServices, EnvelopedVirusMenu EVmenu) {
        this.EVPage = EVPage;
    ...
    public void show() {
        ...
        // Create title
        Label title = new Label("Enveloped Virus Statistics");
    ...
    private BarChart<String, Number> createSeverityChart() {
        ...
        Map<String, Long> severityCount = EVmenu.getVirusInMenu().stream()
                .collect(Collectors.groupingBy(EnvelopedVirus::getSeverity, Collectors.counting()));
    ...
    private PieChart createGeneticMaterialChart() {
        ...
        Map<String, Long> geneticMaterialCount = EVmenu.getVirusInMenu().stream()
                .collect(Collectors.groupingBy(EnvelopedVirus::getGeneticMaterialType, Collectors.counting()));
    ...
    private BarChart<String, Number> createMutationRateChart() {
        ...
        Map<String, Long> mutationRateCount = EVmenu.getVirusInMenu().stream()
    ...
    private BarChart<String, Number> createIncubationPeriodChart() {
        ...
        Map<String, Long> incubationPeriodCount = EVmenu.getVirusInMenu().stream()
                .collect(Collectors.groupingBy(virus -> {
